...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/hfreebuds5i.png')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/freebuds/alt1.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/freebuds/alt2.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/freebuds/alt3.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/freebuds/alt4.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
reviewImages.forEach(reviewImage => {
    if (!reviewImage.classList.contains('with-image')) {
        document.querySelectorAll('.r-images').forEach(imageArea => {
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_freebuds', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.freebuds);
...
favoritar.addEventListener('click', function () {
    ...
    let favProduct = {
        "freebuds": {
            ...
            "image": "img/acessories/hfreebuds5i.png",
    ...
    const productExists = getFavorite.some(item => item.freebuds);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.freebuds));
...
function filtrar() {
	...
	//VERIFICANDO SE TEM ITENS NA LISTA
     ...
     document.querySelector('.fa-reply').style.display = ''
	 }else{ 
        document.querySelector('.fa-reply').style.display = 'none'
