...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/mmotog04s.png')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/motog04s/alt1.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/motog04s/alt2.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/motog04s/alt3.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/motog04s/alt4.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
document.getElementById('var1').addEventListener('click', function () {
    variationName.innerText = '128GB 4GB'
})
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_motoZeroFour', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.motogfour);
...
favoritar.addEventListener('click', function () {
    ...
    let favProduct = {
        "motogfour": {
            ...
            "image": "img/phones/mmotog04s.png",
    ...
    const productExists = getFavorite.some(item => item.motogfour);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.motogfour));
