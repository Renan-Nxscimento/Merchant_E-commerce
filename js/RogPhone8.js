...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/rphone9.png')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/rogphone8/alt1.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/rogphone8/alt2.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/rogphone8/alt3.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/rogphone8/alt4.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
document.getElementById('var1').addEventListener('click', function () {
    variationName.innerText = '256GB 12GB'
})

document.getElementById('var2').addEventListener('click', function () {
    variationName.innerText = '256GB 16GB'
})

document.getElementById('var3').addEventListener('click', function () {
    variationName.innerText = '512GB 16GB'
})
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_rogPhoneEight', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.rogphoneeight);
...
favoritar.addEventListener('click', function () {
    ...
    const productExists = getFavorite.some(item => item.rogphoneeight);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.rogphoneeight));
