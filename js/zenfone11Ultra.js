...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/azenfone11ultra.png')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/zenfone11ultra/alt1.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/zenfone11ultra/alt2.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/zenfone11ultra/alt3.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/phones/AltImgs/zenfone11ultra/alt4.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_zenEleven', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.zenfoneelevenultra);
...
favoritar.addEventListener('click', function () {
    ...
    let favProduct = {
        "zenfoneelevenultra": {
            ...
            "image": "img/phones/azenfone11ultra.png",
    ...
    const productExists = getFavorite.some(item => item.zenfoneelevenultra);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.zenfoneelevenultra));
