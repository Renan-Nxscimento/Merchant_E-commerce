...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/sgbuds2.webp')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/gbuds2/alt1.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/gbuds2/alt2.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/gbuds2/alt3.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/acessories/AltImgs/gbuds2/alt4.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
document.getElementById('var1').addEventListener('click', function () {
    variationName.innerText = 'Branco'
})
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_GbudsTwo', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.gbudstwo);
...
favoritar.addEventListener('click', function () {
    ...
    let favProduct = {
        "gbudstwo": {
            ...
            "image": "img/acessories/sgbuds2.webp",
    ...
    const productExists = getFavorite.some(item => item.gbudstwo);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.gbudstwo));
