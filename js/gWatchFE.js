...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/watches/gwatchFE.webp')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/watches/AltImgs/gwatchfe/alt1.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/watches/AltImgs/gwatchfe/alt2.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/watches/AltImgs/gwatchfe/alt3.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/watches/AltImgs/gwatchfe/alt4.webp')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_GwatchFe', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.gwatchfe);
...
favoritar.addEventListener('click', function () {
    ...
    let favProduct = {
        "gwatchfe": {
            ...
            "image": "img/watches/gwatchfe.webp",
    ...
    const productExists = getFavorite.some(item => item.gwatchfe);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.gwatchfe));
