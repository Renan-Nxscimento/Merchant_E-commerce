...
document.querySelector('.alt1').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/javelin.png')"
...
document.querySelector('.alt2').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/altJav1.jpg')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt3').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/altJav2.jpg')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt4').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/altJav3.jpg')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})

document.querySelector('.alt5').addEventListener('click', function () {
    productImage.style.backgroundImage = "url('img/altJav4.jpg')"
    backgroundImage = productImage.style.getPropertyValue('background-image').slice(4, -1).replace(/["']/g, "")
})
...
document.getElementById('var1').addEventListener('click', function () {
    variationName.innerHTML = 'Cor: Verde militar'
})

document.getElementById('var2').addEventListener('click', function () {
    variationName.innerHTML = 'Cor: Verde musgo'
})

document.getElementById('var3').addEventListener('click', function () {
    variationName.innerHTML = 'Cor: Tan'
})

document.getElementById('var4').addEventListener('click', function () {
    variationName.innerHTML = 'Cor: Navy gray'
})
...
function adicionarCarrinho() {
    ...
    const gravarProduto = localStorage.setItem('db_javelin', JSON.stringify(product))
...
function checkFavorites() {
    ...
    const productExists = inspectFavorites.some(item => item.javelin);
...
favoritar.addEventListener('click', function () {
    ...
    const productExists = getFavorite.some(item => item.javelin);

    if (!productExists) {
        getFavorite.push(favProduct);
    } else {
        getFavorite = getFavorite.filter(item => !(item.javelin));
